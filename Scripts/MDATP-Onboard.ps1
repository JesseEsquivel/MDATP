...
#Get log path. Will log to Task Sequence log folder if the script is running in a Task Sequence Otherwise log to \windows\temp
try
{
...
#configure bare minimum WDAV settings for signature updates
