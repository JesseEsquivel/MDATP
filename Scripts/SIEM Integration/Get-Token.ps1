...
# -Use to test your MDATP Security Center API, run this first then run Get-Alerts.ps1
# 
# 
...
$authResponse
Out-File -FilePath "$scriptDir\Latest-token.txt" -InputObject $authResponse.access_token
