...
# -Use to test your MDATP Security Center API
# 
# 
...
$token = Get-Content "$scriptDir\Latest-token.txt"      #run the script Get-Token.ps1  - make sure you are running this script from the same folder of Get-Token.ps1
...
#test MDATP security center api
