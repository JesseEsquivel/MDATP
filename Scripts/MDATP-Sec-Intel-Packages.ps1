...
# v1.0 Initial creation 08/05/2019 - Download MDATP Security Intelligence Packages
#
# 
# 
...
#$vdmpathbase = '\\n005uxn-filea01.sof.socds.mil\mdatp$\wdav-update\{00000000-0000-0000-0000-'
...
cmd /c "cd $vdmpath & mpam-fe.exe /x"
Write-Host "Success." -ForegroundColor Green
Write-Host
