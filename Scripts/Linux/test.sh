...
echo -e "\e[36mTesting connection to download server...\e[0m"
...
echo -e "\e[36mChecking that ${managedFile} file is present...\e[0m"
if [ -f "$managedPath" ]; then
	echo -e "\e[32mMdatp Managed json file found!\e[0m"
	echo
else
